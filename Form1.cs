    ...
    public partial class form1 : Form
    {
        ...
        public void AddLab_Gb(GroupBox gb, Dictionary<string, string> dict)
        {
            ...
            for (int i = 0; i < dict.Count; i++)
            {
                ...
                label.AutoSize = true;
                label.Location = new Point(left, 25 + 35 * i);//label坐标
                gb.Controls.Add(label);

                RadioButton RadioButton = new RadioButton();
                RadioButton.Name = gb.Name + "rb" + i;
                RadioButton.Text = dict.ElementAt(i).Key;

                RadioButton.AutoSize = true;
                RadioButton.Location = new Point(left + 110, 24 + 35 * i);//label坐标
